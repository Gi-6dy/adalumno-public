                    ...
                    {twoFactorEnabled ? (
                        <div className="flex flex-col items-start justify-start space-y-4">
                            ...
                            <p className="text-muted-foreground">
                                ...
                                se te solicitará un PIN aleatorio y seguro al
                                iniciar sesión, que puedes recuperar desde
                        ...
                        <div className="flex flex-col items-start justify-start space-y-4">
                            ...
                            <p className="text-muted-foreground">
                                ...
                                se te solicitará un PIN seguro al iniciar sesión.
                                Puedes obtener este PIN desde una aplicación
